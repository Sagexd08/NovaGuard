...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-nova': 'linear-gradient(135deg, #3b82f6 0%, #22c55e 100%)',
        'gradient-nova-reverse': 'linear-gradient(135deg, #22c55e 0%, #3b82f6 100%)',
  ...
  plugins: [
    ...
    // Custom plugin for glass morphism and gradient utilities
